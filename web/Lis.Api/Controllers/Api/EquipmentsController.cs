...
namespace Lis.Api.Controllers.Api
{
    public class EquipmentsController : ApiController
    {
        ...
        public EquipmentsController(IEquipmentManager equipmentManager,
            IResponseManager responseManager, 
            IHubContext<ILisClient> context,
            ILogger Logger,
        ...
        public EquipmentMaster Get(int Id)
        {
            try
            {
                var equipment = dBContext.EquipmentMaster.SingleOrDefault(x => x.Id == Id);
